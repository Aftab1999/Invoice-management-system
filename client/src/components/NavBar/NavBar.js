    ...
    <div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
        <span className="link-text">Dashboard</span>
          ...
          <li className="nav-item">
            <a href="/product-categories" className="nav-link">
              ...
              <span className="link-text">Product Categories</span>
            </a>
          </li>

          <li className="nav-item">
            <a href="/productslist" className="nav-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-box">
                <path d="M21 16V8a2 2 0 0 0-2-2h-4V3a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v3H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h4v3a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-3h4a2 2 0 0 0 2-2z"></path>
