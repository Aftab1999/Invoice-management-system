...
// API endpoints
export const createCategory = (newCategory) => API.post('/productcategories', newCategory);
export const fetchCategory = () => API.get('/productcategories');
export const fetchCategoryById = (id) => API.get(`/productcategories/${id}`); // Fetch single category by ID
export const updateCategory = (id, updatedCategory) => API.put(`/productcategories/${id}`, updatedCategory);
export const deleteCategory = (id) => API.delete(`/productcategories/${id}`);
...
// Define API functions for Client operations
export const fetchClients1 = (page) => API.get(`/clients?page=${page}`);
export const fetchClientsByUser1 = (userId) => API.get(`/clients/user?searchQuery=${userId}`);
export const createClient1 = (newClient) => API.post('/clients', newClient);
export const fetchClientById1 = (id) => API.get(`/clients/${id}`);
export const updateClient1 = (id, updatedClient) => API.patch(`/clients/${id}`, updatedClient);
export const deleteClient1 = (id) => API.delete(`/clients/${id}`);

// Additional API calls can be defined here as needed
